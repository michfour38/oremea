...
const capabilities = [
  ...
  ["CRUSHING", "crushing", "Crushing", "Crushes food or confectionery inputs to a required production size or texture.", ["FOOD", "BEVERAGE"]],
  ...
  ["CHEMICAL_TESTING", "chemical-testing", "Chemical testing", "Performs chemical analysis relevant to product quality, safety or specification.", ["FOOD", "BEVERAGE", "SKINCARE", "PERSONAL_CARE", "SUPPLEMENTS"]],
  ["PHYSICAL_TESTING", "physical-testing", "Physical testing", "Measures physical product properties against defined quality or specification requirements.", ["FOOD", "BEVERAGE", "SKINCARE", "PERSONAL_CARE", "SUPPLEMENTS"]],
  ["SENSORY_TESTING", "sensory-testing", "Sensory testing", "Evaluates product sensory or organoleptic characteristics.", ["FOOD", "BEVERAGE"]],
