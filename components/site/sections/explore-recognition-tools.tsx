export function ExploreRecognitionTools() {
  return (
      ...
      <div className="mx-auto max-w-6xl px-5 py-24">
        <div className="max-w-3xl">
          ...
          <p className="mt-8 text-base leading-8 text-zinc-300">
            ...
            and relational dynamics over time.
          </p>
        </div>
        ...
        <div className="mt-16 grid gap-8 md:grid-cols-2">
          <div className="rounded-3xl border border-amber-200/10 bg-amber-100/[0.03] p-10">
            ...
            <div className="mt-6 space-y-5 text-base leading-8 text-zinc-300">
              ...
              <p>
                The system is designed to help surface:
              </p>

              <ul className="space-y-3">
                <li>• recurring relational patterns</li>
                <li>• emotional loops</li>
                <li>• reflective inconsistencies</li>
                <li>• communication tendencies</li>
                <li>• awareness gaps over time</li>
              </ul>
            </div>
          </div>
          ...
          <div className="rounded-3xl border border-white/10 bg-white/[0.02] p-10">
            ...
            <div className="mt-6 space-y-5 text-base leading-8 text-zinc-300">
              ...
              <p>
                The system supports reflective synthesis across:
              </p>

              <ul className="space-y-3">
                <li>• communication loops</li>
                <li>• recurring interaction patterns</li>
                <li>• alignment inconsistencies</li>
                <li>• relational distortions</li>
                <li>• dynamic interaction systems</li>
              </ul>
            </div>
          </div>
        </div>
